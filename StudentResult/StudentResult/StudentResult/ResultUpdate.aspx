<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Staff.Master" AutoEventWireup="true" CodeBehind="ResultUpdate.aspx.cs" Inherits="StudentResult.ResultUpdate" %>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                               ...
                               <div class="col-md-6">
                                    ...
                                    <label>Choose Sem <span class="text-danger">*</span></label>
                                    <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Always">
                                            <ContentTemplate>
                                                <asp:DropDownList ID="ddlSem" runat="server" CssClass="form-control" Style="padding: 17px !important; color: #000">
                                                    <asp:ListItem Value="">--Select Sem--</asp:ListItem>
                                                    <asp:ListItem Value="Semester1">Semester1</asp:ListItem>
                                                    <asp:ListItem Value="Semester2">Semester2</asp:ListItem>
                                                    <asp:ListItem Value="Semester3">Semester3</asp:ListItem>
                                                    <asp:ListItem Value="Semester4">Semester4</asp:ListItem>
                                                    <asp:ListItem Value="Semester5">Semester5</asp:ListItem>
                                                    <asp:ListItem Value="Semester6">Semester6</asp:ListItem>
                                                </asp:DropDownList>
                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator5" Display="Dynamic" ForeColor="Red" ControlToValidate="ddlSem" runat="server" ErrorMessage='Choose Sem'></asp:RequiredFieldValidator>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </div>
                                <div class="form-group pt-2">
                                  ...
                                  <div class="form-group pt-2">
                                    <label> Internal Exam <span class="text-danger">*</span></label>
                                        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
                                             <Triggers>
                                                <asp:AsyncPostBackTrigger ControlID="txtInternal" EventName="TextChanged" />
                                            </Triggers>
                                            <ContentTemplate>
                                                <asp:TextBox ID="txtInternal" CssClass="form-control" placeholder="Enter Class" OnTextChanged="txtInternal_TextChanged" AutoPostBack="true"  runat="server"></asp:TextBox>
...
ErrorMessage="Enter value in specified range" ForeColor="Red" MaximumValue="50" MinimumValue="1"   
SetFocusOnError="True" Type=" Integer"></asp:RangeValidator>  
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                       </div>
                                    <div class="form-group pt-2">
                                    <label>University Exam <span class="text-danger">*</span></label>
...
ErrorMessage="Enter value in specified range" ForeColor="Red" MaximumValue="100" MinimumValue="1"   
SetFocusOnError="True" Type=" Integer"></asp:RangeValidator> 
                                            </ContentTemplate>
                                            <Triggers>
