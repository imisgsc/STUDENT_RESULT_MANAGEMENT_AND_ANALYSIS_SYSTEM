...
{
    public partial class ViewFailResult : System.Web.UI.Page
    {
        ...
        protected void getData(int pageIndex)
        {
            ...
            try
            {
                ...
                Cmd.Parameters.Add("@qtype", SqlDbType.VarChar, 50).Value = "faillistdata";
        ...
        protected void rptUsers_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            if (e.CommandName == "delete")
            {
                ...
                if (noError)
                {
                    Response.Redirect("ViewFailResult.aspx?msg=" + rMSG);
                }
                else
                {
                    pnlerror.Visible = true;
