<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Staff.Master" AutoEventWireup="true" CodeBehind="ViewResult.aspx.cs" Inherits="StudentResult.ViewResult" %>
                     ...
                     <div class="card-body">
                       ...
                       <div class="col-md-4 pt-2">
                            <asp:Button ID="btnSearch" class="btn btn-secondary btn-md" OnClick="btnSearch_Click" ValidationGroup="txtSearch" runat="server" Text="Search" />
                              <a href="ResultUpdate.aspx" class="btn btn-success btn-md">Result Update</a>
                        </div>
                    </div>
                     </div>
                                ...
                                <HeaderTemplate>
                                    <table class="table  table-bordered">
                                        <tr class="data text-light textr">
                                            ...
                                            <th class="text-center" style="width: 5%">Upload Marksheet</th>
                                        </tr>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <tr >
                                       ...
                                       <td class="text-center text-success">
                                        ...
                                        <td class="text-center">
                                            <a href="EditResult.aspx?mode=edit&Id=<%#(DataBinder.Eval(Container.DataItem,"Id")) %>"title="Edit profile " data-toggle="tooltip" data-placement="top" class="btn btn-default btn-sm btn-warning "><i class="fa fa-edit iconColor"></i></a>
                                         ...
                                         <td class="text-center">
                                            <a href="UploadMarksheet.aspx?mode=edit&Id=<%#(DataBinder.Eval(Container.DataItem,"Id")) %>"title="Upload Mark Sheet" data-toggle="tooltip" data-placement="top" class="btn btn-default btn-sm btn-primary "><i class="mdi mdi-file-import"></i></a>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                                <FooterTemplate>
